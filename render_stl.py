...
# for stl_part_number in range(3, 60):  # Adjust this range based on how many STL files you have
#     clear_mesh_objects()
...
for stl_part_number in range(1, 20):  # Adjust this range based on how many STL files you have
    clear_mesh_objects()
    ...
    # Randomly select a color from the list for each iteration
...
for stl_part_number in range(1, 20):
    clear_mesh_objects()
